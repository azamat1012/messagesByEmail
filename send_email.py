...
На курсы, которые еще не вышли, можно подписаться и получить уведомление о релизе сразу на имейл.""".format(ad_from=sender_email, ad_to=recipient_email, f_name=recipient_name, my_name=sender_name, website=website)
